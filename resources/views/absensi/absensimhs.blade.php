...
<div class="row justify-content-center">
    <div class="btn btn-outline-light text-light col-md-5 border-0">
        <main class="form-registration">
            ...
            <form action="/absensimhs" method="post" class="">
                @csrf
                ...
                <div class="form-floating">
                    ...
                    <input type="text" class="form-control" name="nim" placeholder="Nomor Induk Mahasiswa" autocomplete="off">
                </div>
                <div class="form-floating">
                ...
                <button class="w-50 btn btn-outline-primary mt-1" type="submit"><font face="algerian">Absen</font></button>
            </form>
